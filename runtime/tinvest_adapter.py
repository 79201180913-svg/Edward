...
class AdapterState:
    ...
    def sandbox_positions(self, account_id):
        ...
        logger.info("[SANDBOX BALANCE] SDK GetSandboxPositions account_id=%s response=%s", account_id, data)
        return data
    ...
    def sandbox_portfolio(self, account_id):
        ...
        data = message_to_dict(result)
        logger.info("[SANDBOX BALANCE] SDK GetSandboxPortfolio account_id=%s response=%s", account_id, data)
        return data
    ...
    def sandbox_withdraw_limits(self, account_id):
        ...
        data = message_to_dict(result)
        logger.info("[SANDBOX BALANCE] SDK GetSandboxWithdrawLimits account_id=%s response=%s", account_id, data)
        return data
